...
namespace luckywp\wikiLinkingPremium\plugin\repositories;
...
class ItemRepository extends BaseObject
{
    ...
    public function save($item)
    {
        ...
        if ($item->anchorChanged && Core::$plugin->settings->getValue('general', 'bind_on_item_anchor_save')) {
            Core::$plugin->bindItemToPosts($item);
        }
    }
