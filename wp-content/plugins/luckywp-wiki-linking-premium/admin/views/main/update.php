 ...
 * @var $model \luckywp\wikiLinkingPremium\admin\forms\main\UpdateForm
 */

use luckywp\wikiLinkingPremium\admin\helpers\AdminHtml;
use luckywp\wikiLinkingPremium\admin\widgets\selectPost\SelectPost;
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <?php if (!Core::$plugin->settings->getValue('general', 'bind_on_item_anchor_save')) { ?>
