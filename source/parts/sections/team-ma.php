<?php if (!empty(carbon_get_theme_option('main_team_ma_card'))) { ?>
<section class="section team">
	<div class="container">
		<?php if (!empty(carbon_get_theme_option('main_team_ma_title'))) : ?>
			<h2 class="title">
				<?php echo carbon_get_theme_option('main_team_ma_title'); ?>
			</h2>
		<?php endif ?>
		<div class="team__items">
			<?php foreach ((carbon_get_theme_option('main_team_ma_card')) as $key) : ?>
				<div class="team__item">
					<div class="team__item-top">
						<div class="team__item-inner">
							<div class="team__photo-box">
								<img class="team__photo" src="<?php echo $key['main_team_ma_photo']; ?>" alt="photo">
							</div>
